...
<head>
    ...
    <!-- morrisjs CSS
		============================================ -->
    <link rel="stylesheet" href="../penjual/css/morris../penjual/js/morris.css">
...
<body>
    ...
    <!-- jquery
		============================================ -->
    <script src="../penjual/js/vendor/jquery-1.11.3.min.js"></script>
    <!-- bootstrap JS
		============================================ -->
    ...
    <!-- tab JS
		============================================ -->
    <script src="../penjual/js/tab.js"></script>
    <!-- icheck JS
		============================================ -->
    <script src="../penjual/js/icheck/icheck.min.js"></script>
    <script src="../penjual/js/icheck/icheck-active.js"></script>
    <!-- plugins JS
		============================================ -->
